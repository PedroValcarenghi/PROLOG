...
module.exports = {
    ...
    pergunta(mus, gen, cant) {
        ...
        var program =
            ...
            "musica('Losin My Religion', 'Alternativo', 'REM', 'https://open.spotify.com/track/31AOj9sFz2gM0O3hMARRBx?si=YmnX_kNRTz2qP5hM349P9A')." +
            "musica('Everybody Hurts','Alternativo', 'REM', 'https://open.spotify.com/track/6PypGyiu0Y2lCDBN1XZEnP?si=nSRMKMEnT6G6kma_HV70hw')." +
            ...
            //rock
            "musica('Yesterday', 'Rock', 'Beatles', 'https://open.spotify.com/track/3BQHpFgAp4l80e1XslIjNI?si=Ki5M61xiSLOxAI6PrZd9OA')." +
            "musica('Bohemian Rhapsody', 'Rock', 'Queen', 'https://open.spotify.com/track/3z8h0TU7ReDPLIbEnYhWZb?si=WAklTnswTg-0PhPAcVBEFA')." +
            "musica('Love Of My Life', 'Rock', 'Queen', 'https://open.spotify.com/track/4JO4B5UbDaBMX3uKOkWq3T?si=Ok-3mahVQ0KfyrWSggQcXg')." +
            "musica('Sweet Child O Mine', 'Rock', 'Guns N Roses', 'https://open.spotify.com/track/7o2CTH4ctstm8TNelqjb51?si=w5BGmVRTTQOv8tK2OV93VQ')." +
            "musica('Californication', 'Rock', 'Red Hot Chili Peppers', 'https://open.spotify.com/track/48UPSzbZjgc449aqz8bxox?si=7drqksWMTbSLMdrHq-ym2A')." +
